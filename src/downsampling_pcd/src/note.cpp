...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle nh;
  ros::Subscriber sub = nh.subscribe("orig_cloud_pcd", 100, downsampling_pointcloud2);//subscribeするtopicの名前　サブスクライバのキューサイズ　spin()実行時に呼ばれる関数名
